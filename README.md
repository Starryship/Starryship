...
你们好！欢迎来到我的github主页。我是福州大学计算机与大数据学院，数据科学与大数据技术专业的一名学生。现在在攻读的领域为AI、大数据和前端。对于AI，我喜欢搭建神经网络和调优，完成各种任务，喜欢学习和研究各种网络架构，涉及到的领域有自然语言处理、计算机视觉（2D和3D）、多模态、语音识别和声音克隆等，在研项目有"SV3D 宠物图像到视频扩散模型进行新的多视图合成和 3D 生成宠物虚拟形象"和“基于MindSpore实现LoRA到SV3D单图潜在合成多视角视频”。对于自己的专业领域，我擅长数据处理和数据采集，善于使用hadoop等的分布式计算框架和scrapy、selenuim分布式爬虫与可视化。对于前端领域，善于利用vue3框架搭建设计web。
...
-->
<p><img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=starryship&" alt="starryship" width="400"/></p>
